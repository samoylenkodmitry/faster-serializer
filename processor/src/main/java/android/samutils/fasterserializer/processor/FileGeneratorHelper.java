...
public final class FileGeneratorHelper {
	...
	{
		final StringBuilder builder = new StringBuilder("package android.samutils.fasterserializer.processor;\n\n");
		...
		try { // write the file
			final JavaFileObject source = filer.createSourceFile("android.samutils.fasterserializer.processor." + fileName);
